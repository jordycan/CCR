        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (Integer.parseInt(request.getParameter("id_empleado")) != 0) {
                ...
                try {
                    ...
                    dao_empleado empleados = new dao_empleado(con);
                    boolean respuesta = empleados.EliminarEmpleado(id_empleado);

                    if (respuesta != false) {
                         
                               response.sendRedirect("Admin/ActualizarEmpleados.jsp");
                    } else {
