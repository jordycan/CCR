...
<html>
    <head>
        ...
        <title>Reporte por Status</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div id="page-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Reporte por Estado de Pago</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
                        <!-- /.row -->
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="../pdf/ProcesoReporteEstado.jsp" method="post">
                                            <div class="row">

                                                <div class="col-md-4">                    

                                                    <div class="form-group">
                                                        <label for="mes">Status</label>
                                                        <select class="form-control" name="estado" id="mes">
