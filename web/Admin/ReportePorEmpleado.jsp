<%-- 
    Document   : ReportePorEmpleado
    Created on : 1/10/2017, 10:19:17 AM
    Author     : Jordy Can
--%>
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div id="page-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Reporte por Empleado</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
                        <!-- /.row -->
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="../pdf/ProcesoReportePagoEmpleado.jsp" method="post">
                                            <div class="row">
