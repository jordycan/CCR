<%-- 
    Document   : adeudos
    Created on : 18/09/2017, 09:08:28 PM
    Author     : Jordy Can
--%>
...
<head>
  ...
  <title>Ver Adeudos de Clientes</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="ActualizarEmpleados.jsp"><i class="fa fa-user-times"></i>Actualzar de Empleados</a></li>
          </ul>
        </li>
    ...
    <section class="content-header">
     <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="adeudos.jsp">Adeudos</a></li>
        ...
        <div class="col-xs-12">
         ...
         <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabla de Adeudos</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <%
                                            ...
                                            List<CobroDTO> detalles = dao_ventas.adeudo();
