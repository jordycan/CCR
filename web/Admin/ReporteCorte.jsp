<%-- 
    ...
    Created on : 1/10/2017, 12:42:39 PM
    Author     : Jordy Can
--%>
...
<html>
    <head>
        ...
        <title>Reporte por Dia de Corte</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div id="page-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Reporte por Dia de Corte y Localidad</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
                        <!-- /.row -->
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="../pdf/ProcesoCorteReporte.jsp" method="post">
                                            <div class="row">

                                                <div class="col-md-4">                    

                                                    <div class="form-group">
                                                        <label for="mes">Corte</label>
                                                        <select class="form-control" name="corte" id="mes">
                                                 ...
                                                 <div class="col-md-4">                    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="localidad" id="mes">
