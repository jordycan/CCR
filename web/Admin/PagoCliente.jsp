<%--
    ...
    Created on : 23/09/2017, 04:21:55 PM
    Author     : Jordy Can
--%>
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div id="page-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Pagos por Clientes</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
                        <!-- /.row -->
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="PagoCliente.jsp" method="post">
                                            <div class="row">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <% String nombre = request.getParameter("search");
                                                                List<CobroDTO> detalles = dao_ventas.PagoNombre(nombre);
