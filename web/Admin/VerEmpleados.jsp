<%-- 
    ...
    Created on : 16/09/2017, 08:40:11 PM
    Author     : Jordy Can
--%>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     <h1>
        Empleados
        <small>Todos los empleados</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="Principal.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="VerEmpleados.jsp">Ver Empleados</a></li>
  ...
  <section class="content">
      <div class="row">
        <div class="col-xs-12">
            <form action="../pdf/ProcesoReporteEmpleados.jsp" method="post"> 
