...
<html>
    <head>
        ...
        <title>Reporte por Corte y Localidad</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div id="page-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Reporte por Localidad, Mes de corte y Fecha</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
                        <!-- /.row -->
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="../pdf/ProcesoMesCorte.jsp" method="post">
                                            <div class="row">
