<%-- 
    ...
    Created on : 18/09/2017, 12:08:16 AM
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">                    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="id" readonly="readonly" value="<%=df.format(detalles.get(i).getCod_cliente())%>" maxlength="30" id="id" class="form-control" >
                                                    </div>  
                                                ...
                                                <div class="col-md-4">                    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nombre" maxlength="30" value="<%=detalles.get(i).getNom_completo()%>" id="nombre" class="form-control" >
                                                    </div>  
                                                ...
                                                <div class="col-md-4">                    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="direccion" value="<%=detalles.get(i).getDireccion()%>" maxlength="30" id="direccion" class="form-control" >
                                                    </div>  
                                                ...
                                                <div class="col-md-4">                    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="sector" id="sector" selected="Tenabo" >
                                                ...
                                                <div class="col-md-4">                    
                                                    ...
                                                    <div class="form-group">
                                                        <label for="id_tipo">Tipo de Cliente</label>
                                                ...
                                                <div class="col-md-4">                    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="telefono" value="<%=detalles.get(i).getTelefono()%>" maxlength="30" id="telefono" class="form-control" >
                                                    </div>  
