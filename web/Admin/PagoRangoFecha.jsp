<%-- 
    Document   : PagoRangoFecha
    Created on : 23/09/2017, 06:09:14 PM
    Author     : Jordy Can
--%>
...
<html>
    <head>
        ...
        <title>Pago por Rango de Fecha</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div id="page-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Pagos por Rango de Fecha</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
                        <!-- /.row -->
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="PagoRangoFecha.jsp" method="post">
                                            <div class="row">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <% String fecha1 = request.getParameter("fecha1");
                                                                ...
                                                                List<CobroDTO> detalles = dao_ventas.PagoRangoFecha(fecha1, fecha2);
