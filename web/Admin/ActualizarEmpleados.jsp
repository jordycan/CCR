<%-- 
    Document   : ActualizarEmpleados
    Created on : 17/09/2017, 03:43:09 PM
    Author     : Jordy Can
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Empleados
                        <small>Actualizar empleados</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="Principal.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active"><a href="VerEmpleados.jsp">Actualizar Empleados</a></li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Tabla de Empleados</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><%=df.format(detalles.get(i).getId_empleado())%></td>
                                                <td><%=detalles.get(i).getNom_completo()%></td>
                                                <td><%=detalles.get(i).getTelefono()%></td>
                                                <td>
                                                    <a href="../ServletEliminarEmpleado?id_empleado=<%=detalles.get(i).getId_empleado()%>"> <input type="submit" value="Eliminar" class="btn btn-danger"/></a> 
                                                    <a href="EditarEmpleado.jsp?id_empleado=<%=detalles.get(i).getId_empleado()%>"> <input type="submit" value="Editar" class="btn btn-info"/></a> 
