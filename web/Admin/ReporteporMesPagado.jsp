<%-- 
    Document   : ReporteporMesPagado
    Created on : 09-oct-2017, 20:37:03
    Author     : Particular
--%>
...
<html>
    <head>
        ...
        <title>Reporte por Mes Pagado</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div id="page-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Reporte por Mes</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
                        <!-- /.row -->
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="../pdf/ProcesoReporteMesLocalidad.jsp" method="post">
                                            <div class="row">
