<%-- 
    ...
    Created on : 17/09/2017, 10:35:00 PM
    Author     : Jordy Can
--%>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <%                            String id_empleado = request.getParameter("id_empleado");
                                        ...
                                        List<EmpleadoDTO> detalles = dao_empleado.MostrarEmpleadoPorCod(id);
                                        DecimalFormat df = new DecimalFormat("00000000");
                                        for (int i = 0; i < detalles.size(); i++) {
                                    %>
                                    <div class="panel-body">
                                        <form action="../ServletEditarEmpleado" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">                    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="id" readonly="readonly" value="<%=df.format(detalles.get(i).getId_empleado())%>" maxlength="30" id="id" class="form-control" >
                                                    </div>  
